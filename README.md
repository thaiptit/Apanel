...
**An Advanced Web APanel • Built on Xray Core**
...
```
bash <(curl -Ls https://raw.githubusercontent.com/thaiptit/Apanel/master/install.sh)
```

## Install legacy Version (we don't recommend)

To install your desired version, use following installation command. e.g., ver `v1.0`:

```
VERSION=v1.0 && bash <(curl -Ls "https://raw.githubusercontent.com/mhsanaei/3x-ui/$VERSION/install.sh") $VERSION
```
...
- **For versions up to `v1.0`:**
  - The IP limit is built-in to the panel

**For versions `v1.0` and newer:**
